...
namespace Presentation.Forms.Assets.CustomDropdownMenu
{
    public class JMCustomMenuColorTable : ProfessionalColorTable
    {
        // Fields
        ...
        //Constructor
        public JMCustomMenuColorTable(bool isMainMenu, Color primaryColor)
        {
            if (isMainMenu)
            {
