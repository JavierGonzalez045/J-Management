...
{
    public class JMCustomDropdownMenu : ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public JMCustomDropdownMenu(IContainer container)
            : base(container)
        {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            if (this.DesignMode == false)
            {
                ...
                this.Renderer = new JMMenuRenderer(isMainMenu, primaryColor, menuItemTextColor);
            }
        }
    }
}